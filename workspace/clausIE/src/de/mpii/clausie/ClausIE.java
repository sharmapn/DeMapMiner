...
//JEFF switched the package for the following Import statement:
...
public class ClausIE {
	Tree depTree;
	edu.stanford.nlp.semgraph.SemanticGraph  semanticGraph;
	...
	public ClausIE() {
		this(new Options());
		System.out.println("ClausIE Initialised"); 
	}
	...
	public void initParser() {
	    ...
	    System.out.println("ClausIE Initialised using initParser() ");
	}

	/** Clears and parses a new sentence. */
	public void parse(String sentence) {
		if ( sentence==null || sentence == "" || sentence.isEmpty() )
		{	return; }
		try {
			clear();
	//&&		System.out.println(sentence); 
			...
			System.out.println(" ______here CIE 556 " + e.toString() + "\n" );
