...
public class SentenceAnalyzer {
	...
	public static void SentenceDetect() {
		try {
			...
			String paragraph = "As I don't think these discussions will stop even if PEP 308 gets rejected, how about moving them to a seperate newsgroup . Did you call.";

			// always start with a model, a model is learned from training data
			InputStream is = new FileInputStream(NLP_MODELS_PATH + "da-sent.bin");
	...
	public static void main(String[] args) {
		SentenceAnalyzer.SentenceDetect();
		SentenceAnalyzer.findName();
		SentenceAnalyzer.POSTag("I want to eat  then I want to watch movie ");
		SentenceAnalyzer.chunk();
		SentenceAnalyzer.Parse();
		SentenceAnalyzer.Tokenize();
