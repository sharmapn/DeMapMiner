	...
	//						System.out.println("\t\t\tinputFileReasonSubjectMatched && inputFileReasonObjectMatched not matched"); 
					...
					if(firstPart && secondPart && thirdPart ){
						...
						if(location.equals("sameSentence")) {							
								...
								String filename= prp.getScriptsHomeFolderLocation() + "ReasonOutput\\Reasons\\ReasonTripleInSameSentence.txt";
							    FileWriter fw = new FileWriter(filename,true); //the true will append the new data
								...
								String filename= prp.getScriptsHomeFolderLocation() +"ReasonOutput\\Reasons\\ReasonTripleInPreviousSentence.txt";
							    FileWriter fw = new FileWriter(filename,true); //the true will append the new data
							    fw.write("PEP " + result.getPepNumber() + " | " +result.getClausIE() + " | " + v_reason + " | " +inputFileReasonSubject + " | " + inputFileReasonVerb + " | " + inputFileReasonObject +" | " + result.getCurrentSentence() );//appends the string to the file
							    fw.write("\r\n");							    fw.close();							
						}
								...
								String filename= prp.getScriptsHomeFolderLocation() +"ReasonOutput\\Reasons\\ReasonTripleInNextSentence.txt";
							    FileWriter fw = new FileWriter(filename,true); //the true will append the new data
							    fw.write("PEP " + result.getPepNumber() + " | " +result.getClausIE() + " | " + v_reason + " | " +inputFileReasonSubject + " | " + inputFileReasonVerb + " | " + inputFileReasonObject +" | " + result.getCurrentSentence() );//appends the string to the file						    
							    fw.write("\r\n");							    fw.close();							
						}
						else if(location.equals("restOfCurrParagraph")) {							
								String filename= prp.getScriptsHomeFolderLocation() +"ReasonOutput\\Reasons\\ReasonTripleInRestOfCurrParagraph.txt";
							    FileWriter fw = new FileWriter(filename,true); //the true will append the new data
							    fw.write("PEP " + result.getPepNumber() + " | " +result.getClausIE() + " | " + v_reason + " | " +inputFileReasonSubject + " | " + inputFileReasonVerb + " | " + inputFileReasonObject +" | " + result.getCurrentSentence() );//appends the string to the file			  
							    fw.write("\r\n");							    fw.close();							
						}
						else if(location.equals("sentenceInPrevParagraph")) {							
								String filename= prp.getScriptsHomeFolderLocation() +"ReasonOutput\\Reasons\\ReasonTripleInSentenceInPrevParagraph.txt";
							    FileWriter fw = new FileWriter(filename,true); //the true will append the new data
							    fw.write("PEP " + result.getPepNumber() + " | " +result.getClausIE() + " | " + v_reason + " | " +inputFileReasonSubject + " | " + inputFileReasonVerb + " | " + inputFileReasonObject +" | " + result.getCurrentSentence() );//appends the string to the file 
							    fw.write("\r\n");							    fw.close();							
						}
						else if(location.equals("sentenceInNextParagraph")) {							
								String filename= prp.getScriptsHomeFolderLocation() + "ReasonOutput\\Reasons\\ReasonTripleInSentenceInNextParagraph.txt";
							    FileWriter fw = new FileWriter(filename,true); //the true will append the new data
							    fw.write("PEP " + result.getPepNumber() + " | " +result.getClausIE() + " | " + v_reason + " | " +inputFileReasonSubject + " | " + inputFileReasonVerb + " | " + inputFileReasonObject +" | " + result.getCurrentSentence() );//appends the string to the file
							    fw.write("\r\n");							    fw.close();	
						}						
