...
//import processMessages.ProcessPastMessages;
...
//		cec = new create_explicit_corpus();
		...
		//dec 2018
		try {
			inputStream = new FileInputStream("c://DeMapMiner/lib//openNLP//en-sent.bin");		    model = new SentenceModel(inputStream); 	    									
