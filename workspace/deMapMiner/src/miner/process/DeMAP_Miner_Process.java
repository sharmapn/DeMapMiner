...
//import RationaleMiner.PrepareTrainingTestingData.ProcessPastMessages;
...
public class DeMAP_Miner_Process {	
	...
	public static void main(String[] args) throws IOException {
		...
		if(prp.getSentenceParagraphWritingToTable())  {	//if we want to just write each sentence to a database table	
			...
			//15-07-2022 commented as we shifted this class with the newly created rationale miner project 
