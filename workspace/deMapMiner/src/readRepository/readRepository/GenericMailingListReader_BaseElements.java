...
public class GenericMailingListReader_BaseElements {
	...
	*/
	...
	// line lists
	// store proposal number and proposal title in this list and clear it after every line
	// is read
	...
	//May 2021..when reading post BDFL Data (Steering council) i..e after July 11th 2018
	// we select the max messageid
	static Integer messageID = 10066939; ///10000000; //mostly set to 0...unless reading in post BDFL data, will be populated later //1543295; //0; //3000000; //109653; //155850; //155599; //155732; //155599; // 2178486; //390871; //31470; //0;				
				...
				if (!v_message.isEmpty()) {
					try {    
						...
						{}
							...
							boolean matchedproposalNumberInessageSubject = matchproposalNumbersAddToList(proposalNumberSearchKeyList, ignoreList, subject, matchedproposalNumberInMessage,proposalNumberFoundInMessageSubjectList);						
