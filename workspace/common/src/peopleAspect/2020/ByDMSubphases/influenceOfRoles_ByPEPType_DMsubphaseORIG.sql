...
--	SET p_state 
	DECLARE curgetMessages 
			CURSOR FOR 
				SELECT pepnum2020, peptype2020, clusterbysenderfullname, authorsrole, lastdir, COUNT(messageid) 				
				...
				GROUP BY pepnum2020, clusterbysenderfullname, lastdir;			
...
SELECT peptype, author, authorsrole, -- lastdir, 
...
GROUP BY peptype, author ASC -- , authorsrole,  lastdir
