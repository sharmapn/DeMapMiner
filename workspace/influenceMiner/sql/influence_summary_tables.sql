...
CREATE TABLE IF NOT EXISTS influence_actor_summary (
    ...
    unilateral_count INT DEFAULT 0,
    corporate_interest_count INT DEFAULT 0,
    gatekeeping_count INT DEFAULT 0,
    exit_threat_count INT DEFAULT 0,
    incivility_count INT DEFAULT 0,
    backchannel_count INT DEFAULT 0,
    procedural_control_count INT DEFAULT 0,
