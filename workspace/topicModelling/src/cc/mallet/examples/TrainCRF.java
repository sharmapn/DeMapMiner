...
public class TrainCRF {
	...
	public static void callCRF (String output_file, String model_file, String test_file) {
		try {
	...
	public static void main (String[] args) throws Exception {
		...
		//TrainCRF trainer = new TrainCRF(train,test);
		//change to original line
	}
