...
public class ParameterSweeping_MemoryBased {
	static PythonSpecificMessageProcessing pm = new PythonSpecificMessageProcessing();
	static RankingEvaluation_MetricsMethods em = new RankingEvaluation_MetricsMethods();
...
//		        System.out.println("DIR created");
	...
	public static void main(ArrayList<ScoresToSentences> List, HashMap<Integer,String> hmapMessages , double incrementCounter0, double incrementCounter1, double incrementCounter2, 
		...
		String fileDir  = "C:\\DeMapMiner\\results\\reasons_evaluation\\2022\\";
