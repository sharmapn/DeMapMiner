...
public class NERAndVerbExample {
  public static void main(String[] args) throws IOException {
    ...
    for (CoreMap sentence : annotation.get(CoreAnnotations.SentencesAnnotation.class)) {
      edu.stanford.nlp.trees.semgraph.SemanticGraph sg = sentence.get(SemanticGraphCoreAnnotations.CollapsedDependenciesAnnotation.class);
      for (edu.stanford.nlp.trees.semgraph.SemanticGraphEdge sge : sg.edgeListSorted()) {
        System.out.println(
