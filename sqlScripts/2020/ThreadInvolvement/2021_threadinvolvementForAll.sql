...
-- 01 March 2021. We use this script now as the main and only script
...
getMessages: 
		LOOP
			...
			INSERT INTO pepthreadsbyperson2020(threadlevel, pepnum2020,messageid, author, clusterbysenderfullname,  emailmessageid, subject, threadid, inreplyto, authorsrole, peptype2020, folder )
...
getpepsstate: 
		LOOP
			...
			IF finished = 1 THEN 
				LEAVE getpepsstate;
			END IF;
			call createThreadInvolvementForEachPerson_from_secondlevel (v_pepnum2020,v_messageid, v_author, v_clusterbysenderfullname,  v_emailmessageid, 
...
FROM allmessages
WHERE pep <> pepnum2020 AND pep <> -1
GROUP BY pep
