...
-- added later
CREATE TABLE allmessages_announce_list LIKE allmessages;
CREATE TABLE allmessages_authors     LIKE allmessages;
CREATE TABLE allmessages_distutils_sig   LIKE allmessages;
-- CREATE TABLE allmessages_patches 	 LIKE allmessages
...
-- added later
INSERT INTO allmessages_announce_list 	SELECT * FROM allmessages WHERE folder = 'c:\\datasets\\python-announce-list';
INSERT INTO allmessages_authors 	SELECT * FROM allmessages WHERE folder = 'c:\\datasets\\python-authors';
INSERT INTO allmessages_distutils_sig 	SELECT * FROM allmessages WHERE folder = 'c:\\datasets\\python-distutils-sig';
