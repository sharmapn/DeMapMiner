...
The Python study designed the comparison this paper completes. Table~\ref{tab:compare} sets the two projects side by side on the same detector, using Python's extended corpus (1999--2026, 299,192 candidates) and Bitcoin's (2011--2026, 62,789 candidates).
...
Candidate sentences & 62,789 & 299,192 \\
...
Coalition & 2.1 & 2.0 \\
\midrule
Supporting / blocking / revising & 1.5 / 1.4 / 7.7 & 2.0 / 1.5 / 8.8 \\
